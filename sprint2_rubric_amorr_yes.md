...
## Planning Meetings (SR(N-1).md, sprintN.md) (max 2 marks)
  ...
  Planning Meetings Total Mark: 3 / 4 Feedback: Not sure what the team capacity of 81 means
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 1 Feedback: Not all commit messages (excluding merges) begin with the ticket # and some messages are vague (i.e. "bug fix for lacation," "small changes")
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - CRC Cards [or equivalent, if the team is not using CRC) (max 4 marks)
    ...
    Your Mark: 3 Feedback: Even though more crc cards have been added. Issue from our discord discuss have not been fixed - the class called Body and NavBar are still part of the main class app.
...
## Sprint Demo (Max 14 marks) 
  ...
  - Working software (max 2 marks)
	...
	Your Mark: 7 / 8 Feedback: It's unclear how the google API is being used when your using google maps on your browser to enter the location and postal code
