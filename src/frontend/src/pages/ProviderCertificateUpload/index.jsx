...
export default function ProviderCertificateUpload() {
        ...
        if (file) {
            ...
            reader.onload = function() {
                if (1048576 < reader.result.length) {
                    ...
                    axios.post('/api/upload_certificate/', {
                        data: reader.result
                    }).then(
                        resolution => {
                            if (resolution.data.status === 'succeeded') {
                                console.log('Success', resolution.data);
                                alert('Provider certificate successfully uploaded.');
            ...
            <div className="mdui-container p=3">
                ...
                <div className="mdui-row mdui-m-t-5">
                    ...
                    <div className="mdui-col mdui-col-xs-12 mdui-col-sm-8 mdui-col-lg-6 mdui-col-offset-sm-2 mdui-col-offset-lg-3 mdui-m-b-2">
                        <div className="mdui-typo-title mdui-text-color-green mdui-m-b-3 mdui-m-t-2">Your certificate has been verified.</div>
        ...
        return (
            <div className="mdui-container p=3">
                ...
                <div className="mdui-row mdui-m-t-5">
                    ...
                    <div className="mdui-col mdui-col-xs-12 mdui-col-sm-8 mdui-col-lg-6 mdui-col-offset-sm-2 mdui-col-offset-lg-3 mdui-m-b-2">
                        <div className="mdui-typo-title mdui-text-color-red mdui-m-b-3 mdui-m-t-2">Your certificate is rejected. You may upload a new document for us to verify.</div>
                        <div className="mdui-col mdui-col-xs-8 mdui-col-sm-6 mdui-col-lg-4">
                            <input className='mdui-m-b-2 mdui-m-t-1' type='file' id='input'></input>
                            <button className="mdui-btn mdui-btn-block mdui-color-pink-accent mdui-ripple" onClick={handleFileUpload}>Upload</button>
                        </div>
        ...
        return (
            <div className="mdui-container p=3">
                ...
                <div className="mdui-row mdui-m-t-5">
                    ...
                    <div className="mdui-col mdui-col-xs-12 mdui-col-sm-8 mdui-col-lg-6 mdui-col-offset-sm-2 mdui-col-offset-lg-3 mdui-m-b-2">
                        <div className="mdui-typo-title mdui-text-color-deep-orange mdui-m-b-3 mdui-m-t-2">You haven't upload a certificate yet. Upload one so that we can verify your profession.</div>
                        <div className="mdui-col mdui-col-xs-8 mdui-col-sm-6 mdui-col-lg-4">
                            <input className='mdui-m-b-2 mdui-m-t-1' type='file' id='input'></input>
                            <button className="mdui-btn mdui-btn-block mdui-color-pink-accent mdui-ripple" onClick={handleFileUpload}>Upload</button>
                        </div>
