...
**Team Name:** Amorr  
**Github:** https://github.com/UTSCCSCC01/finalprojects22-amorr-yes 
...
## summary.md (Max 8 marks)
  ...
  summary.md Total Mark: 8 / 8 Excellent!
...
## competition.md (Max 2 marks)
  ...
  competition.md Total Mark: 1 / 2 Feedback: Great start with the TaskRabbit, but for some of the other competitors' details need to be elaborated upon.
...
## Product Backlog PB.md (Max 8 marks) 
  ...
  PB.md Total Mark: 8 / 8 Feedback: Great detail in this section!
...
## Personas.pdf (max 8 marks)
  ...
  - Persona Descriptions (max 2 marks)
    ...
    Your mark: 1  Feedback: The 3rd persona is quite short, and 2 personas have similar reasons for using the service. 
...
## Process: process.md (max 10 marks)
  ...
  - Prioritizing user stories (max 2 marks)
    ...
    Your mark: 1 Feedback: What is the planning poker method? Why 2 rounds of vote?
